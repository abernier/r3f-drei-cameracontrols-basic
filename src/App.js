...
function Scene() {
  ...
  const [{ minDistance, enabled, verticalDragToForward, dollyToCursor, infinityDolly }, setGui] = useControls(() => ({
    ...
    lerpLookAt: folder(
      {
        ...
        t: { value: Math.random(), label: 't (random)' },
        'f(…posA,…tgtA,…posB,…tgtB,t)': button((get) => {
          setGui({ t: Math.random() })
